...
namespace StarryNight.View
{
    ...
    class BeeStarHelper
    {
        public static AnimatedImage BeeFactory(double width, double height, TimeSpan flapInterval)
        {
            ...
            imageNames.Add(@"Assets\Bee animation 1.png");
            imageNames.Add(@"Assets\Bee animation 2.png");
            imageNames.Add(@"Assets\Bee animation 3.png");
            imageNames.Add(@"Assets\Bee animation 4.png");
        ...
        private static DoubleAnimation CreateDoubleAnimation(UIElement uiElement,
